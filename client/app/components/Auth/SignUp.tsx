...
const schema = Yup.object().shape({
  ...
  password: Yup.string().required("Пожалуйста введите ваш пароль!").min(6),
});
...
const Signup: FC<Props> = ({ setRoute }) => {
  ...
  useEffect(() => {
    if (isSuccess) {
      const message = data?.message || "Регистрация прошла успешно!";
  ...
  return (
    <div className="w-full">
      <h1 className={`${styles.title}`}>Регистрация в KnowEdge</h1>
